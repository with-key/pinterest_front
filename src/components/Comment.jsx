...
const CommentItem = (props) => {
  //모듈 작성하면서 key 수정
  const {user_profile, user_name, user_id, post_id, contents, insert_dt, likecount } = props;
    ...
    <Flex style={{flexDirection: 'row',}} mg='8px 0'>
      ...
      <Flex 
        ...
        <Flex
          ...
          <Flex width='100%' style={{flexDirection: 'row',}} ai='center' jc='stretch'> 
            <Text size='1.4rem'  mg='0 8px 0 0' weight='700'>{user_name}</Text>
            <Text size='1.2rem' color='var(--primary-gray)'>{TimeCounting(insert_dt, { lang: 'ko'})}</Text>
          </Flex>
          <Flex >
            <Text size='1.2rem' mg='8px 0 0'>{contents}</Text>                
          </Flex>
        </Flex>
        <Flex mg='4px 0 0 8px' ai='center' jc='space-between'>
          <Flex ai='center'>
            ...
            <Text size='1.2rem' color='var(--primary-gray)'>{likecount}</Text>
            <Button height='32px' type='circle'>
          ...
          <Flex ai='center'>
            ...
            <Text size='1.2rem' color='var(--primary-gray)'>유용함</Text>        
          </Flex>
  ...
  return (
    <React.Fragment>
      ...
      <Flex width='auto' jc='flex-end'>
        <Button mg='16px 8px' width='60px' height='40px' children='취소' secondary/>
        <Button mg='16px 0' width='60px' height='40px' children='완료' secondary disabled/>
      </Flex>
    </React.Fragment>
  );
}
